...
class FactorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factor" do
    assert_difference('Factor.count') do
      post factors_url, params: { factor: { analysis_id: @factor.analysis_id, body: @factor.body, title: @factor.title } }
    end
  ...
  test "should update factor" do
    patch factor_url(@factor), params: { factor: { analysis_id: @factor.analysis_id, body: @factor.body, title: @factor.title } }
